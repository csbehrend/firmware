...
void TVS_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  real_T rtb_Sum4;
  real_T rtb_Tx_equal_offset_idx_0;
  real_T rtb_Tx_equal_offset_idx_1;
  real_T rtb_Tx_equal_offset_idx_2;
  real_T rtb_b_b;
  real_T rtb_beq_b;
  ...
  /* Gain: '<S3>/Gain8' incorporates:
    *  Constant: '<S3>/Constant3'
    *  Gain: '<S2>/Tx_equal_gain'
    */
  rtb_Gain4_idx_3 = rtP.MOTOR_ENABLE[0] * rtP.ABS_MAX_TORQUE[0];

  /* Saturate: '<S3>/Max Torque' incorporates:
    *  Gain: '<S3>/Gain8'
    */
  if (rtb_Gain4_idx_3 > rtP.ABS_MAX_TORQUE[0]) {
    rtb_MaxIndividualMotorTorqueN_c = rtP.ABS_MAX_TORQUE[0];
  } else if (rtb_Gain4_idx_3 < 0.01) {
    rtb_MaxIndividualMotorTorqueN_c = 0.01;
  } else {
    rtb_MaxIndividualMotorTorqueN_c = rtb_Gain4_idx_3;
  }
  ...
  rtb_Tx_equal_offset_idx_0 = rtb_Gain4_idx_3;

  /* Outputs for Atomic SubSystem: '<Root>/TVS' */
  /* Saturate: '<S3>/Max Torque' */
  ...
  /* Gain: '<S3>/Gain8' incorporates:
    ...
    *  Gain: '<S2>/Tx_equal_gain'
    */
  rtb_Gain4_idx_3 = rtP.MOTOR_ENABLE[1] * rtP.ABS_MAX_TORQUE[1];

  /* Saturate: '<S3>/Max Torque' incorporates:
    *  Gain: '<S3>/Gain8'
    */
  if (rtb_Gain4_idx_3 > rtP.ABS_MAX_TORQUE[1]) {
  ...
  /* End of Outputs for SubSystem: '<Root>/TVS' */
  rtb_Tx_equal_offset_idx_1 = rtb_Gain4_idx_3;
  ...
  /* Gain: '<S3>/Gain8' incorporates:
    ...
    *  Gain: '<S2>/Tx_equal_gain'
    */
  rtb_Gain4_idx_3 = rtP.MOTOR_ENABLE[2] * rtP.ABS_MAX_TORQUE[2];

  /* Saturate: '<S3>/Max Torque' incorporates:
    *  Gain: '<S3>/Gain8'
    */
  if (rtb_Gain4_idx_3 > rtP.ABS_MAX_TORQUE[2]) {
  ...
  /* End of Outputs for SubSystem: '<Root>/TVS' */
  rtb_Tx_equal_offset_idx_2 = rtb_Gain4_idx_3;
  ...
  /* Gain: '<S3>/Gain8' incorporates:
    ...
    *  Gain: '<S2>/Tx_equal_gain'
    */
  rtb_Gain4_idx_3 = rtP.MOTOR_ENABLE[3] * rtP.ABS_MAX_TORQUE[3];

  /* Saturate: '<S3>/Max Torque' incorporates:
    *  Gain: '<S3>/Gain8'
    */
  if (rtb_Gain4_idx_3 > rtP.ABS_MAX_TORQUE[3]) {
  ...
  /* Gain: '<S5>/Gain4' */
  rtb_Saturation4_idx_0 = 0.5 * rtb_FRMomentArm;

  /* Sum: '<S5>/Add' */
  rtb_Add_idx_0 = rtb_FRMomentArm + rtb_Saturation4_idx_0;

  /* Gain: '<S5>/Gain4' */
  rtb_Gain4_idx_0 = rtb_Saturation4_idx_0;
  ...
  /* Sum: '<S5>/Add' */
  rtb_Add_idx_1 = rtb_FRMomentArm + rtb_Saturation4_idx_0;

  /* Gain: '<S5>/Gain4' */
  rtb_Gain4_idx_1 = rtb_Saturation4_idx_0;
  ...
  /* Sum: '<S5>/Add' */
  rtb_Add_idx_2 = rtb_FRMomentArm + rtb_Saturation4_idx_0;

  /* Gain: '<S5>/Gain4' */
  rtb_Gain4_idx_2 = rtb_Saturation4_idx_0;
  ...
  /* Sum: '<S5>/Add' */
  rtb_Add_idx_3 = rtb_FRMomentArm + rtb_Saturation4_idx_0;
  ...
  if (rtb_b_b != 0.0) {
    ...
    rtb_Add_idx_0 = 0.621 * rtb_Add_idx_2;
    ...
    /* Switch: '<S13>/Switch2' incorporates:
      ...
      *  Switch: '<S13>/Switch'
      */
    if (rtb_Saturation4_idx_0 > rtb_MaxIndividualMotorTorqueN_c) {
      rtb_Saturation4_idx_0 = rtb_MaxIndividualMotorTorqueN_c;
    } else if (rtb_Saturation4_idx_0 < rtb_MinIndividualMotorTorqueN_2) {
      /* Switch: '<S13>/Switch' */
      rtb_Saturation4_idx_0 = rtb_MinIndividualMotorTorqueN_2;
    }

    rtb_Saturation3_idx_3 = -0.621 * rtb_Saturation4_idx_0;
  } else {
    rtb_beq_b = 0.001;
  ...
  if (rtb_b_b != 0.0) {
    ...
    rtb_Saturation4_idx_0 = rtb_Sum4 * rtb_Gain4_idx_0;
    ...
    rtb_Add_idx_2 = 0.621 * rtb_Gain4_idx_2;
  ...
  /* Bias: '<S2>/Tx_equal_offset' incorporates:
    *  Gain: '<S2>/Tx_equal_gain'
    */
  rtb_Gain4_idx_0 = rtb_Tx_equal_offset_idx_0 * rtU->driver_input +
    rtP.ABS_MAX_TORQUE[0];
  rtb_Gain4_idx_1 = rtb_Tx_equal_offset_idx_1 * rtU->driver_input +
    rtP.ABS_MAX_TORQUE[1];
  rtb_Gain4_idx_2 = rtb_Tx_equal_offset_idx_2 * rtU->driver_input +
    rtP.ABS_MAX_TORQUE[2];
  rtb_Gain4_idx_3 = rtb_Gain4_idx_3 * rtU->driver_input + rtP.ABS_MAX_TORQUE[3];
  ...
  /* Sum: '<S5>/Sum2' incorporates:
    *  Saturate: '<S5>/Saturation3'
    */
  rtb_Tx_equal_offset_idx_0 = ((rtb_beq_b + rtb_Saturation3_idx_1) +
    rtb_Add_idx_0) + rtb_Saturation3_idx_3;
  ...
  /* Gain: '<S5>/P' incorporates:
    *  Saturate: '<S5>/Saturation'
    */
  rtb_Tx_equal_offset_idx_1 = rtP.P * rtb_Saturation3_idx_1;

  /* UnitDelay: '<S15>/Unit Delay' */
  rtb_Tx_equal_offset_idx_2 = rtDW->UnitDelay_DSTATE_b;

  /* Gain: '<S11>/Gain' */
  rtb_Add_idx_0 = rtP.I * 0.015 * rtb_beq_b;

  /* UnitDelay: '<S11>/Unit Delay2' */
  rtb_TFL = rtDW->UnitDelay2_DSTATE;
  ...
  if (rtDW->UnitDelay_DSTATE_b > 0.0) {
    ...
    rtb_Saturation3_idx_1 = (rtb_Add_idx_0 + rtDW->UnitDelay1_DSTATE) * 0.5;
  }

  /* Sum: '<S11>/Sum2' incorporates:
    *  Switch: '<S11>/Switch1'
    */
  rtb_Saturation3_idx_3 = rtb_Saturation3_idx_1 + rtb_TFL;

  /* Sum: '<S5>/Sum7' */
  rtb_TFL = rtb_Tx_equal_offset_idx_1 + rtb_Saturation3_idx_3;

  /* Saturate: '<S5>/Saturation4' */
  if (rtb_Saturation4_idx_0 >= -0.001) {
    rtb_Saturation4_idx_0 = -0.001;
  }
  ...
  /* Sum: '<S5>/Sum3' incorporates:
    *  Saturate: '<S5>/Saturation4'
    */
  rtb_Add_idx_1 = ((rtb_Saturation4_idx_0 + rtb_Add_idx_1) + rtb_Add_idx_2) +
    rtb_Add_idx_3;
  ...
  /* Switch: '<S12>/Switch2' incorporates:
    ...
    *  Switch: '<S12>/Switch'
    */
  if (rtb_TFL > rtb_Tx_equal_offset_idx_0) {
    rtb_TFL = rtb_Tx_equal_offset_idx_0;
  } else if (rtb_TFL < rtb_Add_idx_1) {
    /* Switch: '<S12>/Switch' */
    rtb_TFL = rtb_Add_idx_1;
  }
  ...
  if (rtb_TFL > 0.0) {
    ...
    if (rtb_TFL <= 0.001) {
      ...
      rtb_Add_idx_2 = rtb_TFL;
    }

    /* End of Saturate: '<S5>/Saturation1' */
  } else if (rtb_TFL >= -0.001) {
    /* Saturate: '<S5>/Saturation2' */
    rtb_Add_idx_2 = -0.001;
  } else {
    rtb_Add_idx_2 = rtb_TFL;
  ...
  rtb_exitflag = bigM_func(39.2280863132881, 39.2280863132881,
    ...
    * 0.621) + rtP.ABS_MAX_TORQUE[3] * -0.621) + rtb_Add_idx_2, rtb_Sum4,
    ...
    rtb_MaxIndividualMotorTorqueN_c + rtP.ABS_MAX_TORQUE[3], &rtb_TFL,
    &rtb_Saturation3_idx_1, &rtb_Saturation4_idx_0, &rtb_Add_idx_3, 0.2);

  /* Switch: '<S2>/Tx_choose' */
  if (rtb_exitflag > 2) {
    rtb_Gain4_idx_0 = rtb_TFL;
    rtb_Gain4_idx_1 = rtb_Saturation3_idx_1;
    rtb_Gain4_idx_2 = rtb_Saturation4_idx_0;
    rtb_Gain4_idx_3 = rtb_Add_idx_3;
  }

  /* End of Switch: '<S2>/Tx_choose' */

  /* RateLimiter: '<S2>/Tx_rate_limit' */
  rtb_Saturation3_idx_1 = rtP.Torque_Up_Rate_Limit * period;
  rtb_ub_b_idx_0 = -rtP.Torque_Down_Rate_Limit * period;

  /* Bias: '<S2>/Tx_reverse_offset' */
  rtb_Saturation4_idx_0 = rtb_Gain4_idx_0 - rtP.ABS_MAX_TORQUE[0];

  /* DeadZone: '<S2>/Tx_deadband' */
  if (rtb_Saturation4_idx_0 > 0.1) {
    rtb_Saturation4_idx_0 -= 0.1;
  } else if (rtb_Saturation4_idx_0 >= -0.1) {
    rtb_Saturation4_idx_0 = 0.0;
  } else {
    rtb_Saturation4_idx_0 -= -0.1;
  }
  ...
  /* RateLimiter: '<S2>/Tx_rate_limit' */
  rtb_Gain4_idx_0 = rtb_Saturation4_idx_0 - rtDW->PrevY[0];
  if (rtb_Gain4_idx_0 > rtb_Saturation3_idx_1) {
    rtb_Gain4_idx_0 = rtDW->PrevY[0] + rtb_Saturation3_idx_1;
  } else if (rtb_Gain4_idx_0 < rtb_ub_b_idx_0) {
    rtb_Gain4_idx_0 = rtDW->PrevY[0] + rtb_ub_b_idx_0;
  } else {
    rtb_Gain4_idx_0 = rtb_Saturation4_idx_0;
  }

  rtDW->PrevY[0] = rtb_Gain4_idx_0;

  /* End of Outputs for SubSystem: '<Root>/TVS' */

  /* Outport: '<Root>/Tx' */
  rtY->Tx[0] = rtb_Gain4_idx_0;

  /* Outputs for Atomic SubSystem: '<Root>/TVS' */
  /* Bias: '<S2>/Tx_reverse_offset' */
  rtb_Saturation4_idx_0 = rtb_Gain4_idx_1 - rtP.ABS_MAX_TORQUE[1];
  ...
  /* RateLimiter: '<S2>/Tx_rate_limit' */
  rtb_Gain4_idx_0 = rtb_Saturation4_idx_0 - rtDW->PrevY[1];
  if (rtb_Gain4_idx_0 > rtb_Saturation3_idx_1) {
    rtb_Gain4_idx_0 = rtDW->PrevY[1] + rtb_Saturation3_idx_1;
  } else if (rtb_Gain4_idx_0 < rtb_ub_b_idx_0) {
    rtb_Gain4_idx_0 = rtDW->PrevY[1] + rtb_ub_b_idx_0;
  } else {
    rtb_Gain4_idx_0 = rtb_Saturation4_idx_0;
  }

  rtDW->PrevY[1] = rtb_Gain4_idx_0;

  /* End of Outputs for SubSystem: '<Root>/TVS' */

  /* Outport: '<Root>/Tx' */
  rtY->Tx[1] = rtb_Gain4_idx_0;

  /* Outputs for Atomic SubSystem: '<Root>/TVS' */
  /* Bias: '<S2>/Tx_reverse_offset' */
  rtb_Saturation4_idx_0 = rtb_Gain4_idx_2 - rtP.ABS_MAX_TORQUE[2];
  ...
  /* RateLimiter: '<S2>/Tx_rate_limit' */
  rtb_Gain4_idx_0 = rtb_Saturation4_idx_0 - rtDW->PrevY[2];
  if (rtb_Gain4_idx_0 > rtb_Saturation3_idx_1) {
    rtb_Gain4_idx_0 = rtDW->PrevY[2] + rtb_Saturation3_idx_1;
  } else if (rtb_Gain4_idx_0 < rtb_ub_b_idx_0) {
    rtb_Gain4_idx_0 = rtDW->PrevY[2] + rtb_ub_b_idx_0;
  } else {
    rtb_Gain4_idx_0 = rtb_Saturation4_idx_0;
  }

  rtDW->PrevY[2] = rtb_Gain4_idx_0;

  /* End of Outputs for SubSystem: '<Root>/TVS' */

  /* Outport: '<Root>/Tx' */
  rtY->Tx[2] = rtb_Gain4_idx_0;

  /* Outputs for Atomic SubSystem: '<Root>/TVS' */
  /* Bias: '<S2>/Tx_reverse_offset' */
  rtb_Saturation4_idx_0 = rtb_Gain4_idx_3 - rtP.ABS_MAX_TORQUE[3];
  ...
  /* RateLimiter: '<S2>/Tx_rate_limit' */
  rtb_Gain4_idx_0 = rtb_Saturation4_idx_0 - rtDW->PrevY[3];
  if (rtb_Gain4_idx_0 > rtb_Saturation3_idx_1) {
    rtb_Gain4_idx_0 = rtDW->PrevY[3] + rtb_Saturation3_idx_1;
  } else if (rtb_Gain4_idx_0 < rtb_ub_b_idx_0) {
    rtb_Gain4_idx_0 = rtDW->PrevY[3] + rtb_ub_b_idx_0;
  } else {
    rtb_Gain4_idx_0 = rtb_Saturation4_idx_0;
  }

  rtDW->PrevY[3] = rtb_Gain4_idx_0;

  /* Switch: '<S11>/Switch2' */
  if (rtb_Tx_equal_offset_idx_2 > 0.0) {
    /* Update for UnitDelay: '<S11>/Unit Delay2' incorporates:
      *  Sum: '<S11>/Sum1'
      */
    rtDW->UnitDelay2_DSTATE = rtb_Add_idx_2 - rtb_Tx_equal_offset_idx_1;
  } else {
    /* Update for UnitDelay: '<S11>/Unit Delay2' */
    rtDW->UnitDelay2_DSTATE = rtb_Saturation3_idx_3;
  }
  ...
  /* Switch: '<S15>/Switch1' incorporates:
    ...
    *  Switch: '<S15>/Switch'
    */
  if ((rtb_Add_idx_2 < rtb_Add_idx_1 - 0.1) || (rtb_Add_idx_2 >
        rtb_Tx_equal_offset_idx_0 + 0.1)) {
    /* Update for UnitDelay: '<S15>/Unit Delay' */
    rtDW->UnitDelay_DSTATE_b = 1.0;
  } else if ((rtb_Add_idx_2 > rtb_Add_idx_1 + 0.1) && (rtb_Add_idx_2 <
              rtb_Tx_equal_offset_idx_0 - 0.1)) {
    ...
    /* Update for UnitDelay: '<S15>/Unit Delay' incorporates:
      *  Switch: '<S15>/Switch'
      */
    rtDW->UnitDelay_DSTATE_b = rtb_Tx_equal_offset_idx_2;
  }
  ...
  rtDW->UnitDelay1_DSTATE = rtb_Add_idx_0;
  ...
  /* Outport: '<Root>/beq' */
  rtY->beq = rtb_Add_idx_2;

  /* Outport: '<Root>/windup' */
  rtY->windup = rtb_Tx_equal_offset_idx_2;
